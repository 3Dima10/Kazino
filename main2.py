...
# @dp.message_handler(state=UserStates.WaitingForText, content_types=types.ContentType.TEXT)
# async def handle_user_text(message: types.Message, state: FSMContext):
#     user_text = message.text
#     user_id = message.from_user.id
    
#     # Обработайте текст или выполните нужные действия
#     await bot.send_message(user_id, f'Вы отправили следующий текст: {user_text}')
